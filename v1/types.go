...
type ObjectMeta struct {
	...
	UID types.UID `json:"uid,omitempty" protobuf:"bytes,5,opt,name=uid,casttype=github.com/technosophos/kubelite/types.UID"`
...
type Preconditions struct {
	...
	UID *types.UID `json:"uid,omitempty" protobuf:"bytes,1,opt,name=uid,casttype=github.com/technosophos/kubelite/types.UID"`
}
...
type OwnerReference struct {
	...
	// UID of the referent.
	// More info: http://releases.k8s.io/HEAD/docs/user-guide/identifiers.md#uids
	UID types.UID `json:"uid" protobuf:"bytes,4,opt,name=uid,casttype=github.com/technosophos/kubelite/types.UID"`
...
type ObjectReference struct {
	...
	// UID of the referent.
	// More info: http://releases.k8s.io/HEAD/docs/user-guide/identifiers.md#uids
	UID types.UID `json:"uid,omitempty" protobuf:"bytes,4,opt,name=uid,casttype=github.com/technosophos/kubelite/types.UID"`
	// API version of the referent.
...
type List struct {
	...
	// List of objects
	Items []types.RawExtension `json:"items" protobuf:"bytes,2,rep,name=items"`
}
